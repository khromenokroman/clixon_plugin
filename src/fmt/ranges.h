...
struct range_format_kind_
    : std::integral_constant<range_format, std::is_same<uncvref_type<T>, T>::value ? range_format::disabled
...
using range_formatter_type =
    formatter<remove_cvref_t<decltype(range_mapper<buffered_context<Char>>{}.map(std::declval<Element>()))>, Char>;
...
struct formatter<R, Char,
   ...
   private:
    ...
    using string_type = conditional_t<
        std::is_constructible<detail::std_string_view<Char>, decltype(detail::range_begin(std::declval<R>())),
...
struct formatter<join_view<It, Sentinel, Char>, Char> {
   private:
    ...
    using view_ref = conditional_t<std::is_copy_constructible<It>::value, const join_view<It, Sentinel, Char>&,
